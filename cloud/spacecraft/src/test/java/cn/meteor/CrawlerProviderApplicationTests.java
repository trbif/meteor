...
@SpringBootTest(classes = SpacecraftProviderApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
public class CrawlerProviderApplicationTests {
